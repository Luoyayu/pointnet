...
// output: out (b,n,c)
void interpolate_cpu(int b, int m, int c, int n, const float *points,
...
void interpolate_grad_cpu(int b, int n, int c, int m, const float *grad_out,
...
int main() {
    ...
    for (int i = 0; i < b * n * 3; i++) xyz1[i] = randomf();
    for (int i = 0; i < b * m * 3; i++) xyz2[i] = randomf();
    for (int i = 0; i < b * m * c; i++) points[i] = randomf();
